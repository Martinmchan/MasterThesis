...
[mic1, f] = audioread('000219_247_mono1.wav');
[mic2, f] = audioread('000219_247_mono2.wav');
[mic3, f] = audioread('000219_247_mono3.wav');
[mic4, f] = audioread('000219_247_mono4.wav');
...
cameraMatrix = [0 0 1.70; 0 2.85 1.70; 2.85 0 1.70; 2.85 2.85 1.70];
lsb = [-1,-1,0];
