...
func4 = abs(dist23) - abs(sqrt((x-mic2(1)).^2 + (y-mic2(2)).^2 + (z-mic2(3)).^2) - sqrt((x-mic3(1)).^2 + (y-mic3(2)).^2 + (z-mic3(3)).^2));
...
outF = [func1; func2; func3; func4; func5; func6; func7; func8; func9; func10];
