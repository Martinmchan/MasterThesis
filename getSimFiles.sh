...
sshpass -p "pass" scp root@172.25.12.168:/tmp/mic1.wav ~/MATLAB/MasterThesis/MATLAB/
...
#sshpass -p "pass" scp root@172.25.9.27:/tmp/mic5.wav ~/MATLAB/MasterThesis/MATLAB/
