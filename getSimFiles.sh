...
sshpass -p "pass" scp root@172.25.14.27:/tmp/mic6.wav ~/MATLAB/MasterThesis/MATLAB/
sshpass -p "pass" scp root@172.25.15.12:/tmp/mic7.wav ~/MATLAB/MasterThesis/MATLAB/
